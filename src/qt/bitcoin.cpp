...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. Pangubi can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
{
    OutputDebugStringF("Pangubi-Qt: %s\n", msg);
}
#else
...
int main(int argc, char *argv[])
{
    ...
    QApplication::setOrganizationName("Pangubi");
    QApplication::setOrganizationDomain("pangubi.com");
    if (TestNet()) // Separate UI settings for testnet
        QApplication::setApplicationName("Pangubi-Qt-testnet");
    else
        QApplication::setApplicationName("Pangubi-Qt");
