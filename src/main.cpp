...
const string strMessageMagic = "Pangubi Signed Message:\n";
...
int64 GetBlockValue(int nHeight, int64 nFees)
{
    ...
    {
	    nSubsidy = (100+20+5)*COIN; //to be total coin 3000W
    }else if(nHeight<=BlockCountA*2)
    {
	    nSubsidy = (55+5)*COIN;
    }else if(nHeight<=BlockCountA*3)
    {
	    nSubsidy = (30+5)*COIN;
    }else if(nHeight<=BlockCountA*4)
    {
	    nSubsidy = (15+5)*COIN;
    }else if(nHeight<=BlockCountA*5)
    {
	    nSubsidy = (10+5)*COIN;
    }
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; //PGC one day
static const int64 nTargetSpacing = 1 * 60; //PGC 1 minutes
...
bool SetBestChain(CValidationState &state, CBlockIndex* pindexNew)
{
    ...
    {
		int BlockCountA = 43200;
		if(pindexBest->nHeight >= BlockCountA-1440*3) // must update before this time
		{
			strMiscWarning = _("Warning: This version is obsolete, upgrade required!");
			return AbortNode(_("This version is obsolete, upgrade required!"));
		}
