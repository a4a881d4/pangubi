...
public:
    CMainParams() {
        ...
        //   vMerkleTree: 4a5e1e
        const char* pszTimestamp = "Hundreds of millions of years before 16/Sep/2013 Pangu Separates Sky from Earth ";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 110 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("02343214eb8e650031b6179c3ae27f0ea368d6417a62e1cb1dc26b7efd8121990a") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1379180000;
        genesis.nBits    = 0x1e0ffff0;
        genesis.nNonce   = 1830714;

        hashGenesisBlock = genesis.GetHash();
        printf("ghash:%s\n", genesis.GetHash().ToString().c_str());
        printf("gmroot:%s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(genesis.GetPoWHash() == uint256("0x000005ac6c5d303510286ba4bf2a6462bca2411a084781733f7a5422fbe6a7fd"));
        assert(hashGenesisBlock == uint256("0x33642b6f82ac027007dfebd2e25d91d5180b1e1f8e42a4ab2f90ef66f13b68e5"));
        assert(genesis.hashMerkleRoot == uint256("0xd53ede181b0507ae6f2b352e665f1f738ae19df7ca7f36958c586bfac8d58317"));
